export const CreateTunnel = (material, width, height, depth) => {
  ...
  group.add(rightMesh)
  var bottomMesh = new THREE.Mesh(new THREE.CubeGeometry(width, 0.1, depth), material)
  bottomMesh.translateX(width/2)
  group.add(bottomMesh)
  var topMesh = new THREE.Mesh(new THREE.CubeGeometry(width, 0.1, depth), material)
